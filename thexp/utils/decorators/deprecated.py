...
class UnsupportedWarning(DeprecatedWarning):
    ...
    Additionally, the :func:`~deprecation.fail_if_not_removed` decorators
...
def deprecated(deprecated_in=None, removed_in=None, current_version=None,
    ...
    :param deprecated_in: The version at which the decorated method is
                          ...
                          next version to be released when the decorators is
    ...
    # to add this decorators before a formal deprecation period begins.
    ...
    if isinstance(removed_in, date):
        ...
        # deprecation...well, they used the decorators, so it's deprecated.
    ...
    def _function_wrapper(function):
        if should_warn:
            ...
            # The various parts of this decorators being optional makes for
...
def fail_if_not_removed(method):
    ...
    This decorators catches :class:`~deprecation.UnsupportedWarning`
